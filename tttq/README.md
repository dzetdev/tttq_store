...
To update the database use this command from the Web project folder (replace `tttq` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../tttq.Infrastructure/tttq.Infrastructure.csproj -s tttq.Web.csproj
```
